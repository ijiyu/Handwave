...
const rightCatch = new THREE.Mesh(planeGeometry,  new THREE.MeshBasicMaterial({color: 0xff0000,side: THREE.DoubleSide}));
...
const ballTest = new THREE.Mesh(ballGeometry, new THREE.MeshBasicMaterial({color:0xff00ff}));
